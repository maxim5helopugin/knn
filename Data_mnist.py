...
# Return 4 arrays of training/testing data/labels
def readmnist():
	...
	return train_images.reshape(train_images.shape[0],-1), train_labels, test_images.reshape(test_images.shape[0],-1), test_labels